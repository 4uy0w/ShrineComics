<?php 
    ...
    $syntax_update_chapter_status = "UPDATE chapter SET chapter_status='pending' WHERE chapter_id=$chapter_id";
    $exec_update_chapter_status = mysqli_query($server,$syntax_update_chapter_status);

    if($exec_update_chapter_status){
