<?php
	...
	if(mysqli_num_rows($sql_exec) > 0){
		...
		echo "<script> window.location.href = 'http://192.168.100.28/page/register/index.html?error_message=username_already_exists&username=$username&password=$password&email=$email&address=$address&telephone_number=$telephone_number&role=$role'; </script>";
	}else{
